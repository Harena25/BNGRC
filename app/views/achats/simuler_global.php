    ...
    <div class="row">
        <div class="col-12">
            ...
            <div class="row g-3 mb-4">
                ...
                <div class="col-md-4">
                    <div class="card shadow-sm <?php echo ($solde_argent ?? 0) >= ($total_cout ?? 0) ? 'border-success' : 'border-danger'; ?>">
                        <div class="card-body text-center">
                            <i class="bi bi-piggy-bank fs-1 <?php echo ($solde_argent ?? 0) >= ($total_cout ?? 0) ? 'text-success' : 'text-danger'; ?>"></i>
                            <h5 class="mt-2 mb-0"><?php echo number_format(($solde_argent ?? 0) - ($total_cout ?? 0), 2); ?> MAD</h5>
            ...
            <div class="card shadow-sm mb-4">
                <div class="card-body">
                    <form method="GET" action="/achats/simuler-global" class="row g-3 align-items-end">
                        <div class="col-md-8">
                            ...
                            <input type="number" 
                                   ...
                                   max="100" 
                                   step="0.1"
                                   value="<?php echo number_format($frais_achat ?? 10, 1); ?>"
                                   placeholder="Ex: 10">
                            <div class="form-text">
            ...
            <div class="alert alert-info mb-4">
                ...
                <strong>Note:</strong> Un frais d'achat de <strong><?php echo number_format($frais_achat ?? 10, 1); ?>%</strong> 
                    ...
                    <?php else: ?>
                        ...
                        <div class="alert alert-warning m-3 mb-0 d-flex justify-content-between align-items-center">
                            <div>
                                ...
                                <strong>Articles disponibles en stock</strong> - Choisissez entre distribuer le stock existant ou acheter de nouveaux articles
                            </div>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-end">
                                                ...
                                                <?php if ($peutSatisfaire): ?>
                                                    <i class="bi bi-check-circle-fill text-success ms-1" title="Stock suffisant"></i>
                                                <?php else: ?>
                                                    <i class="bi bi-exclamation-triangle-fill text-warning ms-1" title="Stock insuffisant"></i>
                                                <?php endif; ?>
                                            </td>
                                            <td class="text-center">
                                                <a href="/autoDistribution?mode=simulate" 
                                            ...
                                            <td class="text-center">
                                                <a href="/achats/form/<?php echo $item['besoin_id']; ?>" 
                                                   ...
                                                   title="Acheter de nouveaux articles">
                        ...
                        <div class="m-3 alert alert-secondary small mb-0">
                            <i class="bi bi-info-circle me-2"></i>
                            <strong>Distribuer:</strong> Utilise le stock existant pour satisfaire les besoins (recommande si stock suffisant)<br>
                            <strong>Acheter:</strong> Achete de nouveaux articles en utilisant les dons en argent (ignore le stock existant)
                        </div>
                        <?php endif; ?>
                            ...
                            <table class="table table-hover table-striped align-middle mb-0">
                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr class="<?php echo $possible ? '' : 'table-danger'; ?>">
                                            ...
                                            <td class="text-end text-danger"><?php echo number_format($achat['frais'], 2); ?></td>
                                            <td class="text-end fw-bold"><?php echo number_format($achat['montant_total'], 2); ?></td>
                                            <td class="text-center">
                                ...
                                <tfoot class="table-secondary">
                                    <tr>
                                        ...
                                        <td class="text-end fw-bold fs-5"><?php echo number_format($total_cout ?? 0, 2); ?> MAD</td>
                                        <td></td>
                                    </tr>
                                </tfoot>
                            </table>
            ...
            <div class="alert alert-secondary">
                ...
                <ul class="mb-0 mt-2">
                    <li><strong>Articles en stock (tableau jaune):</strong> Vous avez le choix entre distribuer le stock existant ou acheter de nouveaux articles</li>
                    <li><strong>Distribuer:</strong> Utilise la distribution automatique pour allouer le stock existant aux besoins (gratuit)</li>
                    <li><strong>Acheter:</strong> Utilise les dons en argent pour acquerir de nouveaux articles (avec frais)</li>
                    <li><strong>Articles non en stock:</strong> Doivent obligatoirement etre achetes avec les dons en argent</li>
                    <li><strong>Valider tous les achats:</strong> Execute tous les achats des articles non en stock en une seule operation</li>

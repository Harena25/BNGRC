...
CREATE VIEW v_achats_par_ville AS
SELECT 
    a.id AS achat_id,
    v.libelle AS ville_name,
...
-- Achats
INSERT INTO bn_achats (ville_id, article_id, quantite, prix_total, date_achat) VALUES
(1, 1, 10, 350.00, '2026-02-16'),
(2, 3, 5, 62.50, '2026-02-15'),
(3, 5, 20, 500.00, '2026-02-14');
